...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .doc-heading { text-align: center; font-size: 16px; font-weight: 700; color: ${colors.primary}; letter-spacing: 0.5px; }
    ...
    .effect { margin-top: 12px; padding: 10px; background: #E8F5E9; border-radius: 8px; font-size: 12px; color: ${colors.onPrimaryContainer}; }
