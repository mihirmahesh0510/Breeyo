...
export const DRUG_SEED_DATA: SeedDrug[] = [
  ...
  // ─── Vaccines ───
  { name: 'DHPPi (Canine Distemper Combo)', genericName: 'Distemper-Hepatitis-Parainfluenza-Parvovirus', category: 'vaccine', formulations: [{ form: 'injectable', strength: '1 dose', strengthValue: 1, strengthUnit: 'dose' }], dosageRanges: [{ species: 'DOG', minDoseMgPerKg: 0, maxDoseMgPerKg: 0, isFixedDose: true, fixedDoseMin: 1, fixedDoseMax: 1 }] },
  ...
  { name: 'Leptospira', genericName: 'Leptospira Vaccine', category: 'vaccine', formulations: [{ form: 'injectable', strength: '1 dose', strengthValue: 1, strengthUnit: 'dose' }], dosageRanges: [{ species: 'DOG', minDoseMgPerKg: 0, maxDoseMgPerKg: 0, isFixedDose: true, fixedDoseMin: 1, fixedDoseMax: 1 }] },
